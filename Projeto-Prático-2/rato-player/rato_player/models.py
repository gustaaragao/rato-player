...
class Genero:
    ...
    colecoes = relationship('Colecao', secondary=genero_colecao, back_populates='generos')
...
class Colecao:
    ...
    generos = relationship('Genero', secondary=genero_colecao, back_populates='colecoes')
